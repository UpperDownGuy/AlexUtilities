...
class Program
{
    ...
    static void MainMenu()
    {
        ...
        {
            string version = "0.2";
            string githubrepo = "https://github.com/UpperDownGuy/AlexUtilities";
            ...
            Console.WriteLine("[5] App Verification (Check Here If Bugs)");
            ...
            switch (choice)
            {
                ...
                case "5": verifyinteg(); break;
                case "6": info(version, githubrepo); break;
                case "7": return;
                default:
                    Console.ForegroundColor = ConsoleColor.Red;
    ...
    static void verifyinteg()
    {
        Console.Clear();
        Console.ForegroundColor = ConsoleColor.Green;
        Console.WriteLine("App Verification On.");
        Console.WriteLine("Use This If You Have Issues.");
        Console.WriteLine();
        Console.WriteLine("To Verify, Paste all three strings on each line.");
        string string1 = Console.ReadLine();
        string string2 = Console.ReadLine();
        string string3 = Console.ReadLine();

        Console.WriteLine();
        if (string1 == "7NhV-67dx\\1W.._QNx£?)|%Ez!*pB9PNF}8")
        {
            Console.WriteLine("String 1: Passed");
            if (string2 == "&h4)#aU7e1!4q+9H5+L{Fb8X?5fKCzY^vvL")
            {
                Console.WriteLine("String 2: Passed");
                if (string3 == "un/a6S3#f5K4|£3eU8u$<rXV`yB-,dKD{Cl")
                {
                    Console.WriteLine("String 3 Passed");
                    Console.WriteLine("Application Not Corrupt. If there is a bug, please report to Github!");
                }
                else
                {
                    Console.WriteLine("String 1: Failed, Check Spelling or App Is Corrupted. Please Reinstall If Corrupted.");
                }
            }
            else
            {
    ...
    static void info(string version, string githubrepo)
    {
        Console.Clear();
        Console.ForegroundColor = ConsoleColor.Cyan;
        Console.WriteLine();
        ...
        Console.WriteLine($"GitHub: {githubrepo}");
        Console.ForegroundColor = ConsoleColor.Red;
        Console.WriteLine("Developed by UpperDownGuy 💖");
        Console.ResetColor();
        Console.WriteLine();
        Console.WriteLine("Press Enter To Continue...");
        Console.ReadLine();
